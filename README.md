...
https://jobs.smartrecruiters.com/BoschGroup/744000095395264-fullstack-engineer-f-m-div-

Fullstack Engineer (f/m/div.)
```
EN 16 - km 3.7 - Cacia, Aveiro, Portugal
Full-time
...
Shape the future: Implement modern software architectures with the latest technologies in an international environment;
...
Implement reliably: Support software teams in Web Applications development using a micro frontend architecture;
...
Education:
B.Sc. or M.Sc. Degree in Computer Science or similar field;
 
Experience:
At least 4 years of experience with focus on web development preferable with Angular (nice to have experience in cloud solutions);
Knowledge in technologies like React, Vue.js, Spring boot, C# or Kotlin, is also considered;
 
Know-how:
Good knowledge of web architectures, documentation, developing and testing;
 
Personality:
Proactive, responsible, keen on technology and appreciation for being part technological products development;
 
Working style:
Structured and solution-oriented mindset. Self-organized work style;
...
On the frontend, we use Angular 19+, Typescript, and RxJS in a Micro Frontend Architecture;
